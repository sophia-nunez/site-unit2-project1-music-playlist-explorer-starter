...
function createPlaylistCard(playlist) {
  ...
  playlistHTML = `
            <div class="img-wrapper"><img class="playlist-cover" src="${
              playlist.playlist_art
            }"><i class="fa-solid fa-pencil playlist-icon" onclick="editPlaylist(event)" id="${
    playlist.playlistID
  }"></i><i class="fa fa-trash playlist-icon" aria-hidden="true" onclick="deletePlaylist(event)" id="${
    playlist.playlistID
  }"></i></img></div>
            <section class="card-info">
                <div class="card-text">
                    ...
                    <button class="like-container" onclick="likePlaylist(event)" data-id="${
                      playlist.playlistID
                    }"><i id="icon${
    playlist.playlistID
...
function loadFeatured() {
  ...
  // playlistCard.className = 'playlist';
  playlistCard.innerHTML = `<div id="featured-playlist">
...
function editPlaylist(event) {
  ...
  const playlist = playlists.find(
    (playlist) => playlist.playlistID === event.target.id
  );
